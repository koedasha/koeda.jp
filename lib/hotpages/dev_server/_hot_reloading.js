...
ws.onmessage = async function (event) {
  ...
  switch (data.action) {
    ...
    case "reload:css":
      ...
      break;
    case "reload:js":
      log("⚠️ Hot reloading JS is currently not supported. Please reload page manually.")
...
async function reloadHtmlDocument() {
  let currentUrl = cacheBustedUrl(urlWithParams(window.location.href, { hotreload: "true" }))
